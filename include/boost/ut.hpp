...
class runner {
 ...
 public:
  ...
  auto on(events::test<Ts...> test) {
    ...
    if (detail::cfg::list_tags) {  // TODO: find a possibly better place
...
// TODO: find right runtime polymorphisms to switch between reporter w/o
//  'virtual dispatch' ... since static_polymorphism doesn't work
//  with runtime arguments this leaves `std::variant` which needs
//  a lot of wrappers/iterators 🤔
